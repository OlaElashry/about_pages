            ...
            children: [
             ...
             /* VerticalDivider(
              ...
              IntrinsicWidth(
                child: Column(
                  children: [
                    Text(widget.name!,style: TextStyle(color: Colors.black87,fontSize: 12,fontFamily: 'Pacifico'),),
              
                    Text('Mobile app Developer',style: TextStyle(color: Colors.black45,fontSize: 8,fontFamily: 'Pacifico'),),
                    ...
                    Text(widget.info!,style: TextStyle(color: Colors.black87,fontSize: 8,fontFamily: 'Pacifico'),),
                  ],
                ),
              ),
            ],
